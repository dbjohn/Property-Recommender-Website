              ...
              function PlacementCreative_1364310691859(creative) {
                ...
                this.exitEvents["clickThru"] = {
                    reportingId: 466565,
                    url: this.replaceMacros("https://interactive.lottery.ie//player/draw/purchaseDrawGame.do?gameId=10000001", creative),
                ...
                this.childAssets = new Object();
                  this.childAssets["728x90_dc_golf.swf"] = {
                    isHostedByCdn: false,
                    cdnName: "PID_1621349_728x90_dc_golf.swf",
                    isVideo: false,
                    streamingUrl: "",
                    progressiveUrl: "",
                ...
                for(var assetName in this.childAssets) {
                  if (!core.isPartOfArrayPrototype(assetName)) {
                    ...
                    if(!asset.isHostedByCdn) {
                      var fileUrl = creative.mediaServer + "/2336235/" + asset.cdnName;
               ...
               function InPage_1364310691859(creative, type) {
                  this.variableName = "0_1_" + (new Date()).getTime();
                  this.url = creative.mediaServer + "/2336235/PID_1621349_728x90_dc.swf";
                  this.altText = "";
                  this.width = "728";
                  this.height = "90";
                  this.wmode = "opaque";
              ...
              function InPageHTML_1364310691859(creative, type) {
                  this.variableName = "0__" + (new Date()).getTime();
                  this.url = creative.mediaServer + "/2336235/";
                  this.altText = "";
                  this.width = "";
                  this.height = "";
                  this.assetType = type;
              ...
              var core = new RichMediaCore_74_01();
              var baseCreative = new RichMediaCreative_1364310691859(core.CREATIVE_TYPE_INPAGE);
              var creative = new PlacementCreative_1364310691859(baseCreative);
              var isFlashAssetExist = true;
              if(creative.shouldDisplayFlashAsset) {
                creative.assets[core.ASSET_TYPE_INPAGE] = new InPage_1364310691859(creative, core.ASSET_TYPE_INPAGE);
              ...
              if(creative.forceHTML5Creative || creative.isHTML5PreviewMode || !creative.shouldDisplayFlashAsset || !isFlashAssetExist) {
                ...
                creative.assets[core.ASSET_TYPE_INPAGE] = new InPageHTML_1364310691859(creative, core.ASSET_TYPE_INPAGE);
              }
              dartRichmediaCreatives[dartRichmediaCreatives.length] = creative;
              RichMediaCore_74_01.prototype.trackCsiEvent("gb");  
              document.write('<scr' + 'ipt src="' + baseCreative.globalTemplateJs + '" language="JavaScript"></scr' + 'ipt>');
              RichMediaCore_74_01.prototype.trackCsiEvent("pe") 
